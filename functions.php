  ...
  require_once 'connection.php';
    ...
    function getUsers( array $params = []){
         ...
         */
            ...
            $orderBy = array_key_exists('orderBy', $params) ? $params['orderBy'] : 'nome';
           ...
           $records = [];
            ...
            $sql = 'SELECT * FROM leggendari ';
             if($search){
                 $sql .= "WHERE nome LIKE '%$search%' ";
                 $sql .= " OR tipo1 LIKE '%$search%' ";
                 $sql .= " OR  tipo2 LIKE '%$search%' ";
                 $sql .= " OR id_leggendari LIKE '%$search%' ";
             }
...
function countUsers( array $params = []){
    ...
    $sql = 'SELECT COUNT(*) as total FROM leggendari ';
    if($search){
        $sql .= "WHERE nome LIKE '%$search%' ";
        $sql .= " OR tipo1 LIKE '%$search%' ";
        $sql .= " OR  tipo2 LIKE '%$search%' ";
